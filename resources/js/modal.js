                ...
                <div class="file_link selected" aria-hidden="true" data-toggle="tooltip" data-placement="auto" :title="file">
                    <div class="link_icon">
                        <template v-if="fileIs(file, 'image')">
                            <div class="img_icon" :style="imgIcon('http://simpatik/storage/'+file)"></div>
                        </template>
        ...
        <div class="flex">
            <div id="left">
                ...
                <div id="file_loader" v-if="is_loading">
                                                            <img src="http://simpatik/admin/voyager-assets?path=images%2Flogo-icon.png" alt="Voyager Loader">
...
`,
    ...
    var vm = this;
    vm.is_loading = true;
    $.post('http://simpatik/admin/media/files', { folder: vm.current_folder, _token: 'gppG4FBHyL0I8CN1PGIH90iMEySCWtsCtIPQDPJX', details: vm.details }, function(data) {
    vm.files = [];
    ...
    $.post('http://simpatik/admin/media/new_folder', { new_folder: vm.current_folder+'/'+name, _token: 'gppG4FBHyL0I8CN1PGIH90iMEySCWtsCtIPQDPJX' }, function(data) {
    if(data.success == true){
    ...
    var vm = this;
    $.post('http://simpatik/admin/media/delete_file_folder', {
    ...
    $.post('http://simpatik/admin/media/move_file', {
    path: vm.current_folder,
    files: vm.selected_files,
    ...
    var vm = this;
    var postData = Object.assign(croppedData, { _token: 'gppG4FBHyL0I8CN1PGIH90iMEySCWtsCtIPQDPJX' });
    $.post('http://simpatik/admin/media/crop', postData, function(data) {
    if (data.success) {
    ...
    dropzone.dropzone({
    timeout: 180000,
    url: 'http://simpatik/admin/media/upload',
    ...
    formData.append("_token", 'gppG4FBHyL0I8CN1PGIH90iMEySCWtsCtIPQDPJX');
