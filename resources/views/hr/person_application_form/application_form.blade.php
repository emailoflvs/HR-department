...
@section('content')
    ...
    <h1 class="page-title">
        <i class="voyager-person"></i> Анкета кадидата
    </h1>
    ...
    <div class="page-content container-fluid">
        <div class="row">
            <div id="dbManager" class="col-md-12">
                ...
                @include(".hr.person_application_form.application_form_top")

                {{--                @include("hr.person_info_form_action")--}}

                {{--                @include("hr.person_info_form_interview")--}}

                {{--                @include(".hr.person_application_form,person_info_form_buttom")--}}
                @include(".hr.person_application_form.application_form_buttom")
