...
@section('content')
    ...
    <h1 class="page-title">
        <i class="voyager-chat"></i> Беседы после стажировки
    </h1>
    ...
    <div class="page-content container-fluid">
        <div class="row">
            <div id="dbManager" class="col-md-12">
                    ...
                    @isset ($people)
                        @foreach ($people as $person)
                            ...
                            <tr class="newTableRow">
                                <td>
                                    {{ \Carbon\Carbon::parse($person->date_added_to_database)->format('d.m.yy')?? '' }}
                                </td>
                                <td>
                                    <a href="/hr_person_edit/{{ $person->id }}">{{ $person->surname ?? '' }} {{ $person->name ?? '' }}</a>
                                </td>
                ...
                {{--                        --}}{{--                            <div class="row">--}}
                {{--                        --}}{{--                                <div class="col-md-12"><label for="name">Название таблицы</label><br> <input type="text"--}}
