...
@section('content')
            ...
            <div class="side-body padding-top">
                ...
                <div class="container-fluid">
                    <h1 class="page-title">
                        <i class="voyager-person"></i> Карта клиента
                    </h1>
...
{{--                                                        неверный формат JSON--}}
{{--                                                    </div>--}}
{{--                                                    <div class=" ace_editor ace-github" style="height: 132px;"><div style="position: absolute;"></div><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; height: 12px; width: 6.00031px; left: 37px; top: 0px;"></textarea><div class="ace_gutter"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="margin-top: 0px; height: 156px; width: 33px;"><div class="ace_gutter-cell " style="height: 12px;"><span class="ace_fold-widget ace_start ace_open" style="height: 12px;"></span></div><div class="ace_gutter-cell " style="height: 12px;"></div><div class="ace_gutter-cell " style="height: 12px;"></div><div class="ace_gutter-cell " style="height: 12px;"><span class="ace_fold-widget ace_start ace_open" style="height: 12px;"></span></div><div class="ace_gutter-cell " style="height: 12px;"></div><div class="ace_gutter-cell " style="height: 12px;"></div><div class="ace_gutter-cell " style="height: 12px;"><span class="ace_fold-widget ace_start ace_open" style="height: 12px;"></span></div><div class="ace_gutter-cell " style="height: 12px;"></div><div class="ace_gutter-cell " style="height: 12px;"></div><div class="ace_gutter-cell " style="height: 12px;"></div><div class="ace_gutter-cell " style="height: 12px;"></div></div><div class="ace_gutter-active-line" style="top: 0px; height: 12px;"></div></div><div class="ace_scroller" style="left: 33px; right: 0px; bottom: 0px;"><div class="ace_content" style="margin-top: 0px; width: 343px; height: 156px; margin-left: 0px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 484.025px; visibility: visible;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height:12px;top:0px;left:0;right:0;"></div></div><div class="ace_layer ace_text-layer" style="padding: 0px 4px;"><div class="ace_line" style="height:12px"><span class="ace_paren ace_lparen">{</span></div><div class="ace_line" style="height:12px">    <span class="ace_variable">"default"</span>: <span class="ace_string">""</span>,</div><div class="ace_line" style="height:12px">    <span class="ace_variable">"null"</span>: <span class="ace_string">""</span>,</div><div class="ace_line" style="height:12px">    <span class="ace_variable">"options"</span>: <span class="ace_paren ace_lparen">{</span></div><div class="ace_line" style="height:12px"><span class="ace_indent-guide">    </span>    <span class="ace_variable">""</span>: <span class="ace_string">"-- None --"</span></div><div class="ace_line" style="height:12px">    <span class="ace_paren ace_rparen">}</span>,</div><div class="ace_line" style="height:12px">
<span class="ace_variable">"relationship"</span>: <span class="ace_paren ace_lparen">{</span></div><div class="ace_line" style="height:12px"><span class="ace_indent-guide">    </span>    <span class="ace_variable">"key"</span>: <span class="ace_string">"id"</span>,</div><div class="ace_line" style="height:12px"><span class="ace_indent-guide">    </span>    <span class="ace_variable">"label"</span>: <span class="ace_string">"name"</span></div><div class="ace_line" style="height:12px">    <span class="ace_paren ace_rparen">}</span></div><div class="ace_line" style="height:12px"><span class="ace_paren ace_rparen">}</span></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors"><div class="ace_cursor" style="left: 4px; top: 0px; width: 6.00031px; height: 12px;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="display: none; width: 20px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 20px; height: 132px;"></div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 20px; left: 33px; right: 0px;"><div class="ace_scrollbar-inner" style="height: 20px; width: 376px;"></div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;"></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</div></div></div><textarea id="json-input-&quot;parent_id&quot;" class="resizable-editor" data-editor="json" name="field_details_parent_id" style="display: none;">                                            {"default":"","null":"","options":{"":"-- None --"},"relationship":{"key":"id","label":"name"}}--}}
{{--                                        </textarea>--}}
{{--                                                </div>--}}
{{--                                            </div><div class="row row-dd">--}}
{{--                                                <div class="col-xs-2">--}}
