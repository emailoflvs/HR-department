                ...
                <div class="file_link selected" aria-hidden="true" data-toggle="tooltip" data-placement="auto" :title="file">
                    <div class="link_icon">
                        <template v-if="fileIs(file, 'image')">
                            <div class="img_icon" :style="imgIcon('/storage/'+file)"></div>
                        </template>
...
`,
    ...
    var vm = this;
    vm.is_loading = true;
    $.post('/admin/media/files', { folder: vm.current_folder, _token: 'gppG4FBHyL0I8CN1PGIH90iMEySCWtsCtIPQDPJX', details: vm.details }, function(data) {
    vm.files = [];
    ...
    $.post('/admin/media/new_folder', { new_folder: vm.current_folder+'/'+name, _token: 'gppG4FBHyL0I8CN1PGIH90iMEySCWtsCtIPQDPJX' }, function(data) {
    if(data.success == true){
    ...
    $.post('/admin/media/crop', postData, function(data) {
    if (data.success) {
